...
class Incidents:
    ...
    def update_description(self,incidentnumber,newdesc,description):
        token='Bearer {}'.format(self.access_token)
        url1="https://api.gevernova.com/servicenow_incident/" 
        payload = json.dumps({
                              "update": {
...
class Change:
    ...
    def get_change_tickets_by_query(self,query):
          
          url1="https://api.gevernova.com/servicenow_task_cmdb/querytable/{}/change_request?sso=503437104".format(query)
    ...
    def get_change_details_by_query(self,change_number):
          
          url1="https://api.gevernova.com/servicenow_task_cmdb/querytable/{}/change_request?sso=503437104".format(change_number)
