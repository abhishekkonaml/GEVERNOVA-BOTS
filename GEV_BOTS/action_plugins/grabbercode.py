...
class ActionModule(ActionBase):
    def run(self, tmp=None, task_vars=None):
        ...
        try: 
           ...
           incidents=[incident['Payload']['RequestInfo']['number'] for incident in grabincidents if "network interfaces" in incident['Payload']['RequestInfo']['description'].lower() and "statusflap" in incident['Payload']['RequestInfo']['description'].lower()]
